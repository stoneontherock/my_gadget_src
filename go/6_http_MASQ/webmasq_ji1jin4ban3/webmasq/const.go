...
<p><select name="webScheme"><option value="https://">https</option><option value="http://">http</option></select>://
<input type="text" name="siteAddr" />    <input type="submit" value="提交" /></p>
</form></html>`
...
<input type="submit" value="提交" />
	...
	jump2NewSiteJS = `<html><script language='javascript' type='text/javascript'> setTimeout("javascript:location.href='/zzz'", 0); </script></html>`
)
